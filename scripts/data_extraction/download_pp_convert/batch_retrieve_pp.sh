...
#SBATCH -e %j.err
#SBATCH --time=1:00:00
#SBATCH --array=1,4,7,10,13,16,19,22,25-40 # edit to match the range in array_stream_stash.txt. This can select only the lines needed
#SBATCH --mem=200000
...
processing_queue='./processing_queue_extra-noy.csv'
