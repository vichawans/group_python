...
#m = Basemap(projection='cyl', resolution='c', llcrnrlon=0, llcrnrlat=-90,urcrnrlon=360.01, urcrnrlat=90)
#x, y = m(*np.meshgrid(lons_c, lats))
...
plottitle = 'Ray_' + season_name +  '_' + myjob + '_height' + str(myheight)
#plottitle = 'Rossby Wave Source ($10^{-11}$s$^{-1}$)'
